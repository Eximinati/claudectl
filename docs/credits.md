...
- **[VoltAgent/awesome-claude-code-subagents](https://github.com/VoltAgent/awesome-claude-code-subagents)** — the 154-agent catalog claudectl's [agent library](agent-library.md) mirrors. All credit for the agents goes to their original authors.
